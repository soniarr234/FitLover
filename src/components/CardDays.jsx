...
import '../assets/styles/CardDays.css';

const CardDay = ({ title, link, description, time, image }) => {
  return (
        ...
        <div className="front">
          ...
          <div className="front-content">
            ...
            <div className="description">
              ...
              <p className="card-footer">{time}</p>
            </div>
          </div>
        </div>
      </div>
